...
VALUES
  (
    'admin@outlook.com',
    'Administrador',
    '$2b$10$mHBljwcXFAHfT73HXh5FZOZsgsqmiBGrLALB3qJhSzJ3CLCqWoN8K'
  );
...
VALUES
  (
    'usuario@outlook.com',
    'usuario',
    '$2b$10$V1OXzHqOoG0QJSfN3Iqp6.IXJ5/QVHIAsjBFeA9DVWdrVv1Fyod0u'
  );
...
INSERT INTO
  usuario_permissao (email, id_permissao)
VALUES
  ('usuario@outlook.com', 1);
...
VALUES
  (
    ...
    'Formatação completa com backup e reinstalação de sistema',
    150.00
  );
...
VALUES
  (
    ...
    'Substituição de tela quebrada por peça original',
    250.00
  );
...
VALUES
  (
    ...
    'Limpeza física interna e otimização de desempenho',
    80.00
  );
...
VALUES
  (
    ...
    -- empresas não têm RG
    NULL,
    -- empresas não têm data de nascimento
    'Sim',
    '1234567890012'
  );
...
VALUES
  (
    ...
    'Inspiron 15 3000',
    'SN123456789',
    'Não liga, possível problema na fonte.',
    'Carregador original',
    '1234',
    'ABERTA'
  );